...
<head>
    ...
    <!-- CSS Único para Login -->
     <link rel="stylesheet" href="<?= Config::getAssetsUrl(); ?>/css/login-standalone.css">
    ...
    <div class="login-container">
        ...
        <header class="login-header">
            <div class="logo-container">
                <img src="<?= assetPublicImages('logito.png') ?>" alt="EMPRESA Logo" class="logo">
        ...
        <main class="login-main">
            ...
            <div class="image-section">
                ...
                <img src="<?= assetPublicImages('image1-2.png') ?>" alt="Background" class="bg-image">
            </div>
            ...
            <div class="form-section">
                <div class="login-card">
                    ...
                    <form method="post" action="<?= BASE_URL ?>/app/auth/authenticate.php" class="login-form" id="loginForm">
